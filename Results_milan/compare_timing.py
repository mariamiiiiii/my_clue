...
classic_files = sorted(glob.glob("../gitlab_clue/Results_milan/results_classic*.csv"))
...
# Save results to CSV
mean_df_c.to_csv("../gitlab_clue/Results_milan/classic_mean.csv", index=False)
std_df_c.to_csv("../gitlab_clue/Results_milan/classic_std.csv", index=False)


# Collect all results_unifiedX.csv files
unified_files = sorted(glob.glob("Results_milan/results_unified*.csv"))
...
# Save results to CSV
mean_df_u.to_csv("Results_milan/unified_mean.csv", index=False)
std_df_u.to_csv("Results_milan/unified_std.csv", index=False)


# Collect all results_unified_no_prefetchX.csv files
unified_no_prefetch_files = sorted(glob.glob("Results_milan/results_unified_no_prefetch*.csv"))
...
# Save results to CSV
mean_df_u_no_prefetch.to_csv("Results_milan/unified_mean_no_prefetch.csv", index=False)
std_df_u_no_prefetch.to_csv("Results_milan/unified_std_no_prefetch.csv", index=False)



# === Load all CSVs (aligned with plotting cell expectations) ===
classic_mean = pd.read_csv("../gitlab_clue/Results_milan/classic_mean.csv")
classic_std  = pd.read_csv("../gitlab_clue/Results_milan/classic_std.csv")

# Unified (Prefetch)
unified_mean = pd.read_csv("Results_milan/unified_mean.csv")
unified_std  = pd.read_csv("Results_milan/unified_std.csv")

# Unified (No Prefetch)
unified_no_prefetch_mean = pd.read_csv("Results_milan/unified_mean_no_prefetch.csv")
unified_no_prefetch_std  = pd.read_csv("Results_milan/unified_std_no_prefetch.csv")
...
plt.savefig("Results_milan/mean_comparison.png")
plt.show()
...
plt.grid(axis='y', linestyle='--', alpha=0.7)
plt.ylim(0, 10)
plt.savefig("Results_milan/mean_comparison_zoom_in.png")
plt.show()
...
plt.tight_layout()
plt.grid(axis='y', linestyle='--', alpha=0.7)
plt.savefig("Results_milan/mean_comparison_log.png")
plt.show()
...
plt.tight_layout()
plt.grid(axis='y', linestyle='--', alpha=0.7)
plt.savefig("Results_milan/mean_std_copy_prefetch_noprefetch.png")
plt.show()
...
plt.grid(axis='y', linestyle='--', alpha=0.7)
plt.ylim(0, 10)
plt.savefig("Results_milan/mean_std_copy_prefetch_noprefetch_zoom_in.png")
plt.show()
...
plt.tight_layout()
plt.grid(axis='y', linestyle='--', alpha=0.7)
plt.savefig("Results_milan/mean_std_copy_prefetch_noprefetch_log.png")
plt.show()
...
plt.tight_layout()
plt.grid(axis='y', linestyle='--', alpha=0.7)
plt.savefig("Results_milan/std_comparison.png")
plt.show()
...
plt.grid(axis='y', linestyle='--', alpha=0.7)
plt.ylim(0, 4)
plt.savefig("Results_milan/std_comparison_zoom_in.png")
plt.show()
...
plt.tight_layout()
plt.grid(axis='y', linestyle='--', alpha=0.7)
plt.savefig("Results_milan/std_comparison_log.png")
plt.show()