...
classic_files = sorted(glob.glob("Results_W7800/results_classic*.csv"))
...
# Save results to CSV
mean_df_c.to_csv("Results_W7800/classic_mean.csv", index=False)
std_df_c.to_csv("Results_W7800/classic_std.csv", index=False)


# Collect all results_unifiedX.csv files
unified_files = sorted(glob.glob("Results_W7800/results_unified[1-9].csv") + glob.glob("Results_W7800/results_unified10.csv")
)
...
# Save results to CSV
mean_df_u.to_csv("Results_W7800/unified_mean.csv", index=False)
std_df_u.to_csv("Results_W7800/unified_std.csv", index=False)


# Collect all results_unified_no_prefetchX.csv files
unified_no_prefetch_files = sorted(glob.glob("Results_W7800/results_unified_no_prefetch*.csv"))
...
# Save results to CSV
mean_df_u_no_prefetch.to_csv("Results_W7800/unified_mean_no_prefetch.csv", index=False)
std_df_u_no_prefetch.to_csv("Results_W7800/unified_std_no_prefetch.csv", index=False)


# === Load all CSVs (aligned with plotting cell expectations) ===
classic_mean = pd.read_csv("Results_W7800/classic_mean.csv")
classic_std  = pd.read_csv("Results_W7800/classic_std.csv")

# Unified (Prefetch)
unified_mean = pd.read_csv("Results_W7800/unified_mean.csv")
unified_std  = pd.read_csv("Results_W7800/unified_std.csv")

# Unified (No Prefetch)
unified_no_prefetch_mean = pd.read_csv("Results_W7800/unified_mean_no_prefetch.csv")
unified_no_prefetch_std  = pd.read_csv("Results_W7800/unified_std_no_prefetch.csv")
...
plt.savefig("Results_W7800/approval_linear.png", dpi=300, bbox_inches="tight")
plt.show()
...
plt.savefig("Results_W7800/approval_log.png", dpi=300, bbox_inches="tight")
plt.show()
...
plt.savefig("Results_W7800/approval_linear_zoom_in.png", dpi=300, bbox_inches="tight")
